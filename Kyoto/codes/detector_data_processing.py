...
for file in list_data:
    data1 = pd.read_csv(data_folder+file, encoding='cp932') # cp932 for decoding Japanese
...
np.save('results/detector_data_counts_tensor', data_tensor) # save data with .npy format
